...
int             kfilewrite_offset(struct file *file, char* buffer, uint placeOnFile, uint size);
int             kfileread_offset(struct file *file, char* buffer, uint placeOnFile, uint size);
...
void            procdump(void);
int             proc_handlePageFault(uint64 va);
...
void                    pmd_print(pagetable_t pagetable, struct pagingMetadata *pmd, char *fName, int pid);
...
int                     swapPageOut(pagetable_t pagetable, struct file *swapFile, int ignoreSwapping, struct pagingMetadata *pmd, struct memoryPageEntry *mpe, struct swapFileEntry *sfe, uint64 *ppa);
int                     swapPageIn(pagetable_t pagetable, struct file *swapFile, int ignoreSwapping, struct pagingMetadata *pmd, struct swapFileEntry *sfe, struct memoryPageEntry *mpe, int swapOut);
